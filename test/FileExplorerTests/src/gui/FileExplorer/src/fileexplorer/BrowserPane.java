package clg.project.summer.others.FileExplorer.src.fileexplorer;
...
import clg.project.summer.others.FileExplorer.src.amaras.filesort.DirectoryView;
import  clg.project.summer.others.FileExplorer.src.amaras.runtime.*;
//import javax.swing.text.*;
import java.net.URL;

import clg.project.summer.others.FileExplorer.src.fileexplorer.pref.Application;
import clg.project.summer.others.FileExplorer.src.fileexplorer.pref.Location;
import clg.project.summer.others.FileExplorer.src.fileexplorer.pref.Transfer;
import clg.project.summer.others.FileExplorer.src.fileexplorer.pref.View;
...
public class BrowserPane extends JPanel implements ItemListener {
   ...
   ActionListener homeAction = new ActionListener () {
      public void actionPerformed(ActionEvent e) {
         ...
         String location = prefsLoc.get(Location.START_LOCATION,
                              Location.START_LOCATION_DEFAULT);
      ...
      public void mouseClicked(MouseEvent me){  
         ...
         if (me.getClickCount() == 2) {
            ...
            if (folder.isFile()) {
               ...
               Run runCommand = new Run(newLocVec);
            }
         }  
      }
   ...
   public void copyAction() {
	...
	////This seems to be failing to set the pastemode correctly
      ...
      pasteMode = CopyCut.COPY;

		System.out.println("The static variable COPY=" + CopyCut.COPY);
   ...
   private void prefsTransferPopup() {
       ...
       // Get property from pref menu     
       boolean openTransfer = prefsTransfer.getBoolean(Transfer.OPEN_TRANSFER,
                            Transfer.OPEN_TRANSFER_DEFAULT);
...
//      debug("setShiftModeTest(" +shift +","+value+")");
   ...
   public BrowserPane(String location, int initialWidth, PasteQue pasteBuffer, FileExplorer parentFileExplorer) {
      ...
      this.sortMode = prefsView.getInt(View.SORT_MODE, View.SORT_MODE_DEFAULT);
      this.showHidden = prefsView.getBoolean(View.SHOW_HIDDEN, View.SHOW_HIDDEN_DEFAULT);
   ...
   public int buildBodyPanel(String location) {
      ...
      if ( folder.isDirectory() ) {
         ...
         //}
         DirectoryView dirView = new DirectoryView(folder, showHidden, sortMode);
   ...
   protected ImageIcon createImageIcon(String path,
    ...
    if (imgURL != null) {
        ...
        System.err.println("Couldn'tś find file: " + imgURL.toString());
        return null;
    }
}
   ...
   ActionListener actionOpen = new ActionListener () {
      public void actionPerformed(ActionEvent e) {
         ...
         if (fileList.size() > 0 ){
        	 ...
        	 Run runCommand = new Run(fileList);
         }
   ...
   ActionListener actionOpenWith = new ActionListener () {
      public void actionPerformed(ActionEvent e) {
          ...
          // Get property from pref menu     
          String location = prefsApp.get(Application.APP_LOCATION,
                               Application.APP_LOCATION_DEFAULT);
          ...
          if (retval == JFileChooser.APPROVE_OPTION) {
              ...
              Run runCommand = new Run(Run.DIRECT, fileList);
          } else {
