...
package clg.project.summer.others.FileExplorer.src.amaras.runtime;
...
import clg.project.summer.others.FileExplorer.src.fileexplorer.TransferList;
import clg.project.summer.others.FileExplorer.src.fileexplorer.TransferListItem;
...
public class PasteQue {
   ...
   public boolean joblistComplete() {
      ...
      if (joblist.size() == 0) {
         ...
         boolean closeTransfer = prefsTransfer.getBoolean(Transfer.CLOSE_TRANSFER,
                              Transfer.CLOSE_TRANSFER_DEFAULT);
